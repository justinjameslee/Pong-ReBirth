...
{
    public partial class MouseEasy : Form
    {
        ...
        public MouseEasy()
        {
            ...
            picPaddleBot.Location = new Point(ClientSize.Width - (picPaddleBot.Width + picPaddleBot.Width / 2) - 15, ClientSize.Height / 2 - picPaddleHero.Height / 2);
        ...
        private void MouseEasy_Load(object sender, EventArgs e)
        {
        ...
        private void playerMovement()
        {
            if (this.PointToClient(MousePosition).Y >= picPaddleHero.Height / 2 && this.PointToClient(MousePosition).Y <= ClientSize.Height - picPaddleHero.Height / 2)
            {
                ...
                picPaddleHero.Location = new Point(playerX + 15, playerY);
            }
        }
